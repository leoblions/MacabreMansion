...
public class EnemySlime implements IEntity{
	...
	public final int agroDistance = 300;
	...
	public EnemySlime(GamePanel gp, int startWorldX, int startWorldY) {
	...
	public void loadImages() {
		...
		try {
			playerimages[0]=(ImageIO.read(
					getClass().getResourceAsStream("/characters/slime.png")));
			playerimages[1]=(ImageIO.read(
					getClass().getResourceAsStream("/characters/slime3.png")));
			playerimages[2]=(ImageIO.read(
					getClass().getResourceAsStream("/characters/slime4.png")));
			playerimages[3]=(ImageIO.read(
					getClass().getResourceAsStream("/characters/slime_dead.png")));
		} catch (IOException e) {
	...
	public void cycleImages() {
		if (this.state==EnemyState.WAIT||this.state==EnemyState.CHASE) {
			if (tickcounter < 30) {
				currentImage = playerimages[tickcounter/10];
				tickcounter++;
			}else {
				tickcounter=0;
			}
...
//		
	...
	//gp.g2.fill3DRect(screenX, screenY, width, height,true);
